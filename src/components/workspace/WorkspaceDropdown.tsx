...
export function WorkspaceDropdown() {
  ...
  return (
    <>
      ...
      {/* Switching overlay — prevents seeing stale data while reload is pending */}
      {isSwitching && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-[var(--bg-primary)]/80 backdrop-blur-sm">
