...
// Hardcoded for now — will be dynamic in SKB-23.2
const WORKSPACE_NAME = "SymbioKnowledgeBase";
...
export function WorkspaceDropdown() {
  ...
  const userName = (user?.user_metadata as Record<string, string> | undefined)?.name;
  ...
  return (
    <div ref={containerRef} className="relative" onKeyDown={handleKeyDown}>
      ...
      <button
        ...
        aria-haspopup="menu"
      >
        <WorkspaceAvatar name={WORKSPACE_NAME} size="sm" />
        <span className="flex-1 text-left truncate">{WORKSPACE_NAME}</span>
        <svg
        ...
        >
          ...
          <div className="ws-dropdown-section" role="group" aria-label="Workspace settings">
            <div className="flex items-start gap-3">
              <WorkspaceAvatar name={WORKSPACE_NAME} size="lg" />
          ...
          <div className="ws-dropdown-section" role="group" aria-label="Workspaces">
            ...
            <button
              ...
              role="menuitem"
              onClick={() => {
                // Placeholder — will open WorkspaceCreateDialog in SKB-23.2
              }}
            >
